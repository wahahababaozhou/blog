!function (t) {
    ...
    n.m = t, n.c = r, n.d = function (A, e, t) {
        n.o(A, e) || Object.defineProperty(A, e, {enumerable: !0, get: t})
    }, n.r = function (A) {
        ...
        if (n.r(t), Object.defineProperty(t, "default", {
            enumerable: !0,
            value: e
        }), 2 & A && "string" != typeof e) for (var r in e) n.d(t, r, function (A) {
            return e[A]
        }.bind(null, r));
        return t
    }, n.n = function (A) {
        ...
        run: function (e) {
            new Vue({
                ...
                mounted: function () {
                    ...
                    var A = n.default.get("phone"), A = (A && (this.phone = A), new Date);
                    this.phone.time_hour = 10 <= A.getHours() ? A.getHours() : "0" + A.getHours().toString(), this.phone.time_mini = 10 <= A.getMinutes() ? A.getMinutes() : "0" + A.getMinutes().toString(), this.___(), $(".phone").width(this.phone.mode.width), $(".phone").height(this.phone.mode.height), $(".phone-content").css("transform", "scale(" + this.phone.mode.zoom + ")"), $(".phone-wrap").width(this.phone.mode.width * this.phone.mode.zoom), $(".phone-wrap").height(this.phone.mode.height * this.phone.mode.zoom), window.user = {};
                    try {
                ...
                data: Object.assign({
                    phone: {
                        ...
                        battery_amount: 60,
                        ear: 0,
                        mode: {width: 1125, height: 2436, radio: 3, zoom: .26}
                    }
                }, e.data),
                methods: Object.assign({
                    save: function () {
                        ...
                        $("body").append(t), $(t).find(".phone-body").scrollTop(A), $(".content-wrapper").addClass("loading"), setTimeout(function () {
                            (0, r.default)(t, {scale: 1, scrollY: 0, scrollX: 0}).then(function (A) {
                        ...
                        var B = A < 0 ? "-" : "", s = parseInt(A = Math.abs(+A || 0).toFixed(e), 10) + "",
                        ...
                        return r.replace(A, function (A) {
                            var e = arguments[arguments.length - 2], t = r.substring(B, e);
    ...
    r = function () {
        var K = function (A, e) {
            return (K = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (A, e) {
                A.__proto__ = e
            } || function (A, e) {
        ...
        function Z(A, e, t, r) {
            ...
            if (n === q) for (B = t; 0 < B;) {
                var s, i = r[--B];
                if (Array.isArray(A) ? -1 !== A.indexOf(i) : A === i) for (var o = t; o <= r.length;) {
                    if ((s = r[++o]) === e) return 1;
                    if (s !== q) break
                }
                if (i !== q) break
        ...
        var l, A, q = 10, _ = 13, $ = 15, AA = 17, eA = 18, tA = 19, rA = 20, nA = 21, BA = 22, sA = 24, d = 25,
            iA = 26, oA = 27, aA = 28, cA = 30, QA = 32, gA = 33, CA = 34, uA = 35, lA = 37, wA = 38, UA = 39, EA = 40,
            dA = 42, h = "×", hA = (u = function (A) {
            ...
            fA = [cA, 36], FA = [1, 2, 3, 5], HA = [q, 8], IA = [oA, iA], pA = FA.concat(HA), NA = [wA, UA, EA, CA, uA],
            mA = [$, _], KA = (vA.prototype.slice = function () {
        ...
        var OA = {type: l.LEFT_PARENTHESIS_TOKEN}, SA = {type: l.RIGHT_PARENTHESIS_TOKEN}, PA = {type: l.COMMA_TOKEN},
            VA = {type: l.SUFFIX_MATCH_TOKEN}, XA = {type: l.PREFIX_MATCH_TOKEN}, zA = {type: l.COLUMN_TOKEN},
            JA = {type: l.DASH_MATCH_TOKEN}, xA = {type: l.INCLUDE_MATCH_TOKEN},
            GA = {type: l.LEFT_CURLY_BRACKET_TOKEN}, kA = {type: l.RIGHT_CURLY_BRACKET_TOKEN},
            WA = {type: l.SUBSTRING_MATCH_TOKEN}, YA = {type: l.BAD_URL_TOKEN}, ZA = {type: l.BAD_STRING_TOKEN},
            jA = {type: l.CDO_TOKEN}, qA = {type: l.CDC_TOKEN}, _A = {type: l.COLON_TOKEN},
            $A = {type: l.SEMICOLON_TOKEN}, Ae = {type: l.LEFT_SQUARE_BRACKET_TOKEN},
            ee = {type: l.RIGHT_SQUARE_BRACKET_TOKEN}, te = {type: l.WHITESPACE_TOKEN}, re = {type: l.EOF_TOKEN},
            ne = (e.prototype.write = function (A) {
                ...
                switch (A) {
                    ...
                    case 35:
                        var e, t = this.peekCodePoint(0), r = this.peekCodePoint(1), n = this.peekCodePoint(2);
                ...
                if (r) return n = parseInt(Q.apply(void 0, A.map(function (A) {
                    ...
                    return 63 === A ? 70 : A
                })), 16), {type: l.UNICODE_RANGE_TOKEN, start: n, end: t};
                ...
                if (45 === this.peekCodePoint(0) && RA(this.peekCodePoint(1))) {
                    ...
                    return t = parseInt(Q.apply(void 0, B), 16), {type: l.UNICODE_RANGE_TOKEN, start: n, end: t}
                }
                return {type: l.UNICODE_RANGE_TOKEN, start: n, end: n}
                ...
                return "url" === A.toLowerCase() && 40 === this.peekCodePoint(0) ? (this.consumeCodePoint(), this.consumeUrlToken()) : 40 === this.peekCodePoint(0) ? (this.consumeCodePoint(), {
                    ...
                    value: A
                }) : {type: l.IDENT_TOKEN, value: A}
            }, e.prototype.consumeUrlToken = function () {
                var A = [];
                if (this.consumeWhiteSpace(), -1 === this.peekCodePoint(0)) return {type: l.URL_TOKEN, value: ""};
                ...
                for (; ;) {
                    ...
                    if (-1 === t || 41 === t) return {type: l.URL_TOKEN, value: Q.apply(void 0, A)};
                ...
                if (46 === t && g(r)) for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), e = 8; g(this.peekCodePoint(0));) A.push(this.consumeCodePoint());
                t = this.peekCodePoint(0);
                var r = this.peekCodePoint(1), n = this.peekCodePoint(2);
                if ((69 === t || 101 === t) && ((43 === r || 45 === r) && g(n) || g(r))) for (A.push(this.consumeCodePoint(), this.consumeCodePoint()), e = 8; g(this.peekCodePoint(0));) A.push(this.consumeCodePoint());
                return [function (A) {
                    var e = 0, t = 1;
                    ...
                    var s = B.length, i = s ? parseInt(Q.apply(void 0, B), 10) : 0,
                ...
                var A, e = this.consumeNumber(), t = e[0], e = e[1], r = this.peekCodePoint(0);
                return LA(r, this.peekCodePoint(1), this.peekCodePoint(2)) ? (A = this.consumeName(), {
                    ...
                    number: t,
                    flags: e
                }) : {type: l.NUMBER_TOKEN, number: t, flags: e}
        ...
        t.create = function (A) {
            ...
            for (var e = this.consumeComponentValue(); (A = this.consumeToken()).type === l.WHITESPACE_TOKEN;) ;
            ...
            for (var e = {name: A.value, values: [], type: l.FUNCTION}; ;) {
        ...
        var Fe = function (A, e) {
            ...
            }, C = {type: l.NUMBER_TOKEN, number: 0, flags: 4}, He = {type: l.PERCENTAGE_TOKEN, number: 50, flags: 4},
            Ie = {type: l.PERCENTAGE_TOKEN, number: 100, flags: 4}, D = function (A, e) {
        ...
        function Ke(A) {
            var A = A.filter(Qe), e = A[0], t = A[1], r = A[2], A = A[3],
                e = (e.type === l.NUMBER_TOKEN ? s(e.number) : fe(e)) / (2 * Math.PI), t = U(t) ? t.number / 100 : 0,
                r = U(r) ? r.number / 100 : 0, A = void 0 !== A && U(A) ? D(A, 1) : 1;
            if (0 == t) return Ne(255 * r, 255 * r, 255 * r, 1);
            var t = r <= .5 ? r * (1 + t) : r + t - r * t, r = 2 * r - t, n = me(r, t, e + 1 / 3), B = me(r, t, e),
                r = me(r, t, e - 1 / 3);
            return Ne(255 * n, 255 * B, 255 * r, A)
        }

        var i, ve, Re = {hsl: Ke, hsla: Ke, rgb: he, rgba: he}, be = {
        ...
        function De(A) {
            var e = pe(A[0]), A = A[1];
            return A && U(A) ? {color: e, stop: A} : {color: e, stop: null}
        }
        ...
        function Te(A, t) {
            ...
            for (var o = null, s = 0; s < n.length; s++) {
                var a = n[s];
                if (null === a) null === o && (o = s); else if (null !== o) {
        ...
        function Me(A, e, n, B, s) {
            return [[0, 0], [0, e], [A, 0], [A, e]].reduce(function (A, e) {
                var t = e[0], r = e[1], t = T(n - t, B - r);
                return (s ? t < A.optimumDistance : t > A.optimumDistance) ? {optimumCorner: e, optimumDistance: t} : A
        ...
        function Le(A) {
            ...
            return ge(A).forEach(function (A, e) {
                ...
                e = De(A);
                r.push(e)
            }), {angle: t, stops: r, type: L.LINEAR_GRADIENT}
        }
        ...
        var Pe = {
            ...
            get SUPPORT_RANGE_BOUNDS() {
                ...
                return Object.defineProperty(a, "SUPPORT_RANGE_BOUNDS", {value: A}), A
                ...
                return Object.defineProperty(a, "SUPPORT_SVG_DRAWING", {value: A}), A
            }, get SUPPORT_FOREIGNOBJECT_DRAWING() {
                var A = "function" == typeof Array.from && "function" == typeof window.fetch ? function (t) {
                    var A = t.createElement("canvas"), r = 100, n = (A.width = r, A.height = r, A.getContext("2d"));
                    if (!n) return Promise.reject(!1);
                    n.fillStyle = "rgb(0, 255, 0)", n.fillRect(0, 0, r, r);
                    var e = new Image, B = A.toDataURL(), A = (e.src = B, Oe(r, r, 0, 0, e));
                ...
                return Object.defineProperty(a, "SUPPORT_FOREIGNOBJECT_DRAWING", {value: A}), A
            }, get SUPPORT_CORS_IMAGES() {
                var A = void 0 !== (new Image).crossOrigin;
                return Object.defineProperty(a, "SUPPORT_CORS_IMAGES", {value: A}), A
            }, get SUPPORT_RESPONSE_TYPE() {
                var A = "string" == typeof (new XMLHttpRequest).responseType;
                return Object.defineProperty(a, "SUPPORT_RESPONSE_TYPE", {value: A}), A
            }, get SUPPORT_CORS_XHR() {
                var A = "withCredentials" in new XMLHttpRequest;
                return Object.defineProperty(a, "SUPPORT_CORS_XHR", {value: A}), A
            }
        ...
        Je.prototype.addImage = function (A) {
            ...
            var s = this, i = this._options.proxy;
            if (!i) throw new Error("No proxy defined");
            var o = B.substring(0, 256);
            return new Promise(function (e, t) {
                var A, r = a.SUPPORT_RESPONSE_TYPE ? "blob" : "text", n = new XMLHttpRequest;
                n.onload = function () {
                    var A;
        ...
        function xe(A) {
            var r = y.CIRCLE, n = O.FARTHEST_CORNER, B = [], s = [];
            return ge(A).forEach(function (A, e) {
                var t = !0;
            ...
            }), {size: n, shape: r, stops: B, position: s, type: L.RADIAL_GRADIENT}
        }

        function Ge(A) {
            if (A.type === l.URL_TOKEN) return e = {url: A.value, type: L.URL}, Xe.getInstance().addImage(A.value), e;
        ...
        var L, y, O, ke, We, Ye = /^data:image\/svg\+xml/i, Ze = /^data:image\/.*;base64,/i, je = /^data:image\/.*/i,
            qe = function (A) {
            ...
            }, tt = "closest-side", rt = "farthest-side", nt = "closest-corner", Bt = "farthest-corner", st = "ellipse",
            it = "contain",
            ot = ((c = L = L || {})[c.URL = 0] = "URL", c[c.LINEAR_GRADIENT = 1] = "LINEAR_GRADIENT", c[c.RADIAL_GRADIENT = 2] = "RADIAL_GRADIENT", y = {
                ...
                "radial-gradient": function (A) {
                    var n = y.CIRCLE, B = O.FARTHEST_CORNER, s = [], i = [];
                    return ge(A).forEach(function (A, e) {
                        var t, r = !0;
                        0 === e && (t = !1, r = A.reduce(function (A, e) {
                            if (t) if (w(e)) switch (e.value) {
                                case "center":
                                    return i.push(He), A;
                                case "top":
                                case "left":
                                ...
                                case "bottom":
                                    return i.push(Ie), A
                            } else (U(e) || Ce(e)) && i.push(e); else if (w(e)) switch (e.value) {
                                case "circle":
                                    return n = y.CIRCLE, !1;
                                case st:
                    ...
                    }), {size: B, shape: n, stops: s, position: i, type: L.RADIAL_GRADIENT}
                },
                ...
                "-webkit-gradient": function (A) {
                    var e = s(180), r = [], n = L.LINEAR_GRADIENT, t = y.CIRCLE, B = O.FARTHEST_CORNER;
                    return ge(A).forEach(function (A, e) {
                        var t, A = A[0];
                        if (0 === e) {
                    ...
                    }), n === L.LINEAR_GRADIENT ? {angle: (e + s(180)) % s(360), stops: r, type: n} : {
                        size: B,
                        shape: t,
                        stops: r,
                        position: [],
                ...
                name: "background-image", initialValue: "none", type: i.LIST, prefix: !1, parse: function (A) {
                ...
                name: "background-origin", initialValue: "border-box", prefix: !1, type: i.LIST, parse: function (A) {
                    return A.map(function (A) {
                        if (w(A)) switch (A.value) {
                            case "padding-box":
                                return 1;
                ...
                name: "background-position", initialValue: "0% 0%", type: i.LIST, prefix: !1, parse: function (A) {
                    return ge(A).map(function (A) {
                        return A.filter(U)
                    }).map(ue)
                }
            }, B = ke = {REPEAT: 0, 0: "REPEAT", NO_REPEAT: 1, 1: "NO_REPEAT", REPEAT_X: 2, 2: "REPEAT_X"}, gt = {
        ...
        function lt(A) {
            return {
                name: "border-radius-" + A, initialValue: "0 0", prefix: !1, type: i.LIST, parse: function (A) {
        ...
        var wt, Ut = {
                ...
                return w(A) || U(A)
            }, dt = ut("top"), ht = ut("right"), ft = ut("bottom"), Ft = ut("left"), Ht = lt("top-left"),
            It = lt("top-right"), pt = lt("bottom-right"), Nt = lt("bottom-left");
        ...
        function Kt(A) {
            return {
                name: "border-" + A + "-width", initialValue: "0", type: i.VALUE, prefix: !1, parse: function (A) {
                    return se(A) ? A.number : 0
                }
            }
        }

        wt = {NONE: 0, 0: "NONE", SOLID: 1, 1: "SOLID"};
        var vt, Rt, bt, E, Dt = mt("top"), Tt = mt("right"), Mt = mt("bottom"), Lt = mt("left"), yt = Kt("top"),
            Ot = Kt("right"), St = Kt("bottom"), Pt = Kt("left"),
            Vt = {name: "color", initialValue: "transparent", prefix: !1, type: i.TYPE_VALUE, format: "color"}, Xt = {
                name: "display", initialValue: "inline-block", prefix: !1, type: i.LIST, parse: function (A) {
                ...
                return 0
            }, W = vt = {NONE: 0, 0: "NONE", LEFT: 1, 1: "LEFT", RIGHT: 2, 2: "RIGHT", INLINE_START: 3, 3: "INLINE_START"},
            Jt = {
                name: "float",
                initialValue: "none",
                ...
                name: "letter-spacing", initialValue: "0", prefix: !1, type: i.VALUE, parse: function (A) {
            ...
            }, kt = {name: "line-height", initialValue: "normal", prefix: !1, type: i.TOKEN_VALUE}, Wt = {
                name: "list-style-image", initialValue: "none", type: i.VALUE, prefix: !1, parse: function (A) {
                    return A.type === l.IDENT_TOKEN && "none" === A.value ? null : Ge(A)
                }
            }, c = bt = {INSIDE: 0, 0: "INSIDE"}, Yt = {
        ...
        function Zt(A) {
            return {name: "margin-" + A, initialValue: "0", prefix: !1, type: i.TOKEN_VALUE}
        }
        ...
        }, _t = Zt("top"), $t = Zt("right"), Ar = Zt("bottom"), er = Zt("left");
        ...
        var rr, nr, Br, sr, ir, or, ar, cr = {
            ...
            }, gr = tr("top"), Cr = tr("right"), ur = tr("bottom"), lr = tr("left"),
            W = nr = {LEFT: 0, 0: "LEFT", CENTER: 1, 1: "CENTER"}, wr = {
                name: "text-align",
                initialValue: "left",
                ...
                name: "text-shadow", initialValue: "none", type: i.LIST, prefix: !1, parse: function (A) {
            ...
            }, B = sr = {NONE: 0, 0: "NONE", LOWERCASE: 1, 1: "LOWERCASE", UPPERCASE: 2, 2: "UPPERCASE"}, dr = {
                name: "text-transform",
                initialValue: "none",
                ...
                name: "transform", initialValue: "none", prefix: !0, type: i.VALUE, parse: function (A) {
                ...
                matrix: function (A) {
                    ...
                    var A = A.filter(function (A) {
                            ...
                            return A.number
                        }), e = A[0], t = A[1], r = (A[2], A[3], A[4]), n = A[5],
                        B = (A[6], A[7], A[8], A[9], A[10], A[11], A[12]), s = A[13];
                    return A[14], A[15], 16 === A.length ? [e, t, r, n, B, s] : null
                }
            }, u = {type: l.PERCENTAGE_TOKEN, number: 50, flags: 4}, Fr = [u, u], Hr = {
                name: "transform-origin", initialValue: "50% 50%", prefix: !0, type: i.LIST, parse: function (A) {
                    A = A.filter(U);
                    return 2 !== A.length ? Fr : [A[0], A[1]]
                }
            }, W = ir = {VISIBLE: 0, 0: "VISIBLE", HIDDEN: 1, 1: "HIDDEN"}, Ir = {
                name: "visible",
                initialValue: "none",
            ...
            }, c = or = {NORMAL: "normal", BREAK_ALL: "break-all"}, pr = {
                name: "word-break",
                initialValue: "normal",
                ...
                name: "z-index", initialValue: "auto", prefix: !1, type: i.VALUE, parse: function (A) {
                    if (A.type === l.IDENT_TOKEN) return {auto: !0, order: 0};
                    if (ie(A)) return {auto: !1, order: A.number};
                    throw new Error("Invalid z-index number parsed")
                }
            }, mr = {
                name: "opacity", initialValue: "1", type: i.VALUE, prefix: !1, parse: function (A) {
                ...
                name: "text-decoration-line", initialValue: "none", prefix: !1, type: i.LIST, parse: function (A) {
                    return A.filter(w).map(function (A) {
                        switch (A.value) {
                            case "underline":
                                return 1;
                ...
                name: "font-family", initialValue: "", prefix: !1, type: i.LIST, parse: function (A) {
                    var e = [], t = [];
                    return A.forEach(function (A) {
                        switch (A.type) {
                            case l.IDENT_TOKEN:
            ...
            }, br = {name: "font-size", initialValue: "0", prefix: !1, type: i.TYPE_VALUE, format: "length"}, Dr = {
                name: "font-weight", initialValue: "normal", type: i.VALUE, prefix: !1, parse: function (A) {
                    return ie(A) ? A.number : !w(A) || "bold" !== A.value ? 400 : 700
                }
            }, Tr = {
                name: "font-variant", initialValue: "none", type: i.LIST, prefix: !1, parse: function (A) {
                    return A.filter(w).map(function (A) {
                        return A.value
                    })
                }
        ...
        var Lr, yr = {
            name: "font-style",
            initialValue: "normal",
            prefix: !((Lr = ar = {NORMAL: "normal", ITALIC: "italic"}).OBLIQUE = "oblique"),
            type: i.IDENT_VALUE,
            parse: function (A) {
                switch (A) {
                    case "oblique":
            ...
            name: "content", initialValue: "none", type: i.LIST, prefix: !1, parse: function (A) {
                if (0 === A.length) return [];
                var e = A[0];
                return e.type === l.IDENT_TOKEN && "none" === e.value ? [] : A
            }
        }, Sr = {
            name: "counter-increment", initialValue: "none", prefix: !0, type: i.LIST, parse: function (A) {
            ...
            name: "counter-reset", initialValue: "none", prefix: !0, type: i.LIST, parse: function (A) {
                if (0 === A.length) return [];
                for (var e = [], t = A.filter(ce), r = 0; r < t.length; r++) {
                    var n = t[r], B = t[r + 1];
                    w(n) && "none" !== n.value && (B = B && ie(B) ? B.number : 0, e.push({counter: n.value, reset: B}))
                }
                return e
            }
        }, Vr = {
            name: "quotes", initialValue: "none", prefix: !0, type: i.LIST, parse: function (A) {
                if (0 === A.length) return null;
                var e = A[0];
                if (e.type === l.IDENT_TOKEN && "none" === e.value) return null;
                var t = [], r = A.filter(oe);
            ...
            name: "box-shadow", initialValue: "none", type: i.LIST, prefix: !1, parse: function (A) {
                return 1 === A.length && ae(A[0], "none") ? [] : ge(A).map(function (A) {
                    for (var e = {
                        color: 255,
                        offsetX: C,
            ...
            for (var t, r, n, B, s, i, o, a, c, Q, g, C, u, l, w, U = {
                next: function () {
                    ...
                    for (var A = h; w < u && (A = function (A, e, t, r, n) {
                        ...
                        if (-1 !== [d, aA, sA, AA, eA].indexOf(a)) for (var c = r; 0 <= c;) {
                            if ((B = e[c]) === d) return h;
                            if (-1 === [aA, sA].indexOf(B)) break;
                            c--
                        }
                        if (-1 !== [oA, iA].indexOf(a)) for (c = -1 !== [AA, eA].indexOf(i) ? n : r; 0 <= c;) {
                            if ((B = e[c]) === d) return h;
                            if (-1 === [aA, sA].indexOf(B)) break;
                            c--
                        }
                    ...
                    if (A === h && w !== u) return {done: !0, value: null};
                    var e = new KA(c, A, l, w);
                    return l = w, {value: e, done: !1}
                }
        ...
        var Zr, F = function (A, e) {
            var t = new ne, e = null != e ? e.toString() : A.initialValue, r = (t.write(e), new Be(t.read()));
            switch (A.type) {
                case i.IDENT_VALUE:
        ...
        function on(A) {
            var e = Bn.call(this, A) || this, t = new XMLSerializer;
        ...
        var ln, wn = [{type: l.DIMENSION_TOKEN, flags: 0, unit: "px", number: 3}],
            Un = [{type: l.PERCENTAGE_TOKEN, flags: 0, number: 50}], En = "checkbox", dn = "radio", hn = 707406591,
            fn = (v(Fn, ln = jr), Fn);
        ...
        function pn(A) {
            var e = Hn.call(this, A) || this, A = A.options[A.selectedIndex || 0];
        ...
        var yn = ["OL", "UL", "MENU"], On = function (A) {
        ...
        var sB, iB = {
        ...
        }, CB = "data-html2canvas-ignore", uB = (lB.prototype.toIFrame = function (A, t) {
            var e = this, r = UB(A, t);
            if (!r.contentWindow) return Promise.reject("Unable to find iframe window");
            var n = A.defaultView.pageXOffset, A = A.defaultView.pageYOffset, B = r.contentWindow, s = B.document,
            ...
            var i = this;
            if (e) {
                var o, a, r = e.content, c = A.ownerDocument;
                if (c && r && "none" !== r && "-moz-alt-content" !== r && "none" !== e.display) return this.counters.parse(new Gr(e)), o = new xr(e), a = c.createElement("html2canvaspseudoelement"), dB(e, a), o.content.forEach(function (A) {
                    if (A.type === l.STRING_TOKEN) a.appendChild(c.createTextNode(A.value)); else if (A.type === l.URL_TOKEN) {
        ...
        var wB, UB = function (A, e) {
            ...
            }, HB = "___html2canvas___pseudoelement_before", IB = "___html2canvas___pseudoelement_after",
        ...
        DB.prototype.subdivide = function (A, e) {
            var t = RB(this.start, this.startControl, A), r = RB(this.startControl, this.endControl, A),
                n = RB(this.endControl, this.end, A), B = RB(t, r, A), r = RB(r, n, A), A = RB(B, r, A);
        ...
        function MB(A) {
            var e = A.styles, t = A.bounds, r = (n = le(e.borderTopLeftRadius, t.width, t.height))[0], n = n[1],
                B = (s = le(e.borderTopRightRadius, t.width, t.height))[0], s = s[1],
                i = (o = le(e.borderBottomRightRadius, t.width, t.height))[0], o = o[1],
                a = (c = le(e.borderBottomLeftRadius, t.width, t.height))[0], c = c[1];
            ...
            var Q = t.width - B, g = t.height - o, C = t.width - i, u = t.height - c, l = e.borderTopWidth,
                w = e.borderRightWidth, U = e.borderBottomWidth, E = e.borderLeftWidth,
                d = D(e.paddingTop, A.bounds.width), h = D(e.paddingRight, A.bounds.width),
                f = D(e.paddingBottom, A.bounds.width), e = D(e.paddingLeft, A.bounds.width);
        ...
        var N = function (A, e, t, r, n) {
            var B = (Math.sqrt(2) - 1) / 3 * 4, s = t * B, i = r * B, o = A + t, a = e + r;
            switch (n) {
                case p.TOP_LEFT:
        ...
        function JB(A) {
            var e = A.styles, A = A.bounds, t = D(e.paddingLeft, A.width), r = D(e.paddingRight, A.width),
                n = D(e.paddingTop, A.width), B = D(e.paddingBottom, A.width);
        ...
        function xB(A, e, t) {
            ...
            var r = 0 === r ? n.bounds : (2 === r ? JB : zB)(n),
                ...
                B = jB(qB(A.styles.backgroundSize, e), t, r), t = B[0], s = B[1],
        ...
        function WB(a, c, Q, g) {
            a.container.elements.forEach(function (A) {
                var e, t, r, n, B = f(A.flags, 4), s = f(A.flags, 2), i = new VB(A, a.getParentEffects()),
        ...
        var jB = function (A, e, t) {
            var r = e[0], n = e[1], e = e[2], B = A[0], A = A[1];
        ...
        }, $B = "Hidden Text", As = (es.prototype.parseMetrics = function (A, e) {
            ...
            return B.removeChild(t), {baseline: A, middle: e}
                    ...
                    switch (A.label) {
                        ...
                        case 1:
                            A.sent(), this.ctx.restore(), e.boxShadow.slice(0).reverse().forEach(function (A) {
                                o.ctx.save();
                                var t, r, n, B, e = LB(a.curves), s = A.inset ? 0 : 1e4,
                    ...
                    switch (A.label) {
                        case 0:
                            ...
                            if (s = e.defaultView) return t = (Math.round(1e3 * Math.random()) + Date.now()).toString(16), a = Ln(u) || "HTML" === u.tagName ? function (A) {
                                var e = A.body, A = A.documentElement;
    ...
    "use strict";
    var t = t(1), n = (t = t) && t.__esModule ? t : {default: t};
    A.exports = {
        mounted: function () {
            var A = new Date, e = n.default.get("wechat_setting"), t = n.default.get("wechat_users"),
            ...
            dialogs: [{
                ...
                is_me: !1,
                user_id: "user-2"
            }, {id: "dialog-2", type: "text", content: "hello，world!!!", is_me: !0, user_id: "user-1"}, {
                id: "dialog-3",
                type: "notice",
                ...
                is_get: !0,
                remark: "恭喜发财，大吉大利"
            }, {id: "dialog-8", type: "voice", time: 2, is_me: !1, user_id: "user-2"}, {
                id: "dialog-9",
                type: "voice",
                time: 10,
                is_me: !1,
                user_id: "user-2"
            }, {id: "dialog-10", type: "voice", time: 60, is_me: !0, user_id: "user-1"}]
        }, methods: {
            addUser: function () {
                this.users.push({
                ...
                var e = this.users[A], t = this.dialogs.filter(function (A) {
                ...
                var A = this.setting.date_year + this.setting.date_month + this.setting.date_day + " " + this.setting.date_xinqi + " " + this.setting.date_shiduan + (this.setting.date_shiduan ? parseInt(this.setting.date_hour) : this.setting.date_hour) + ":" + this.setting.date_min,
                    A = {id: "dialog-" + (new Date).valueOf(), type: "notice", content: A};
                ...
                var t = this, A = A.target.files[0], r = new FileReader;
                r.onload = function () {
                    t.dealImage(r.result, {width: 1260, quality: .9}, function (A) {
                        A = {
                            id: "dialog-" + (new Date).valueOf(),
                            type: "image",
                            image: A,
                ...
                if (!A) return alert("请选择用户"), !1;
                if (!this.setting.dialog_money) return alert("请输入金额"), !1;
                var e = this.setting.dialog_repacket_remark, A = {
                    id: "dialog-" + (new Date).valueOf(),
                    type: "redpacket",
                    money: this.setting.dialog_money,
                    is_me: A.is_me,
                ...
                return 0 < A.length ? A[0] : {image: null}
            }, setUserImage: function (A, e) {
                var t = this, A = A.target.files[0], r = new FileReader;
                r.onload = function () {
                    t.dealImage(r.result, {width: 400}, function (A) {
                        t.users[e].image = A
                    })
                }, r.readAsDataURL(A)
            }, setBackground: function (A) {
                var e = this, A = A.target.files[0], t = new FileReader;
                t.onload = function () {
                    e.dealImage(t.result, {width: 1400, quality: .9}, function (A) {
                ...
                e.src = A, e.onload = function () {
                    var A = (e = this.width) / this.height, e = i.width && e > i.width ? i.width : e,
                        A = i.height || e / A, t = .7, r = document.createElement("canvas"), n = r.getContext("2d"),
                ...
                var e = this.dialogs[A], t = this.getUserById(e.user_id),
                    ...
                    }])), t = {id: "dialog-" + (new Date).valueOf(), type: "notice", content: e, is_system: 1};
                this.addDialog(t)
            }, transferGet: function (A) {
                var e = this.dialogs[A], t = e.is_me ? this.getOtherUser() : this.getMeUser(),
